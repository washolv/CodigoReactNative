...
const Post = ({post,conteudo}) => {
    ...
    return(
    <View>
      <ShowDetalhes display={modal} toogleModal={mudaModal} mensagem={post}/>
      
      <Pressable onPress={mudaModal}>

        <Text style={styles.paragraph}>{conteudo}</Text>
      </Pressable>
    </View>
    )
}
...
export default function App() {
  ...
  function meuItem({item}){
    let post = item.userId + " -  " + item.title
